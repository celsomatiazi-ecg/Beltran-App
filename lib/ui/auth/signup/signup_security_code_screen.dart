...
class SignupSecurityCodeScreen extends StatefulWidget {
  const SignupSecurityCodeScreen({super.key});

  @override
  State<SignupSecurityCodeScreen> createState() =>
      _SignupSecurityCodeScreenState();
}
...
class _SignupSecurityCodeScreenState extends State<SignupSecurityCodeScreen>
  ...
  Future<void> _signup() async {
    ...
    try {
      ...
      await authCtrl
          .sendSecurityCode(
            cpf: _signupData.identification ?? "",
            code: _securityCode,
          )
          .whenComplete(() {
            hideLoader();
  ...
  void _navigateTo() {
    Navigator.pushNamed(context, "/signup_password", arguments: _signupData);
  }
