...
class ClientDetailQrCode extends StatefulWidget {
  const ClientDetailQrCode({super.key});

  @override
  State<ClientDetailQrCode> createState() => _ClientDetailQrCodeState();
}

class _ClientDetailQrCodeState extends State<ClientDetailQrCode>
    with AppMessages {
