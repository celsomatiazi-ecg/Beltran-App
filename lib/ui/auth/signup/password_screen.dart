...
class _PasswordScreenState extends State<PasswordScreen>
  ...
  Future<void> _savePassword() async {
    ...
    try {
      ...
      await authCtrl
          .savePassword(
            identification: _signupData.identification ?? "",
  ...
  void _navigateTo() {
    bool isSignup = _signupData.name?.isNotEmpty ?? false;
    Navigator.pushNamed(context, "/signup_message", arguments: isSignup);
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          "Minimo 8 caracteres",
                          style: AppStyle.body.copyWith(color: Colors.black45),
                        ),
                      ],
                    ),
                    const SizedBox(height: 5),
